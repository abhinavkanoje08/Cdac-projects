...
<section class='login' id='login'>
  ...
  <div class='form'>
		<form:form modelAttribute='logins' method="POST"
			...
			<form:input type="text" path='username' placeholder="Enter User Id" class='text' id='username'/>
			<br>
			<form:input type="password" placeholder="Enter Password"  path='password' id='password' class='password'/>
			<br>
