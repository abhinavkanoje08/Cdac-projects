...
<body>
 ...
 <div class="brand">
   <img style="height: 100px; vertical-align: middle; width: 100px;"
			src="https://png.pngtree.com/element_our/sm/20180329/sm_5abc881cb2505.png"><a href="/educos/home">Edu<span style="color:#D68706">Cos</span><span style="font-size: 20px">Learn</span></a>
    </div><br/><br><br/><br>
     &nbsp;
...
<div class="placeholder">
 ...
 <div class="dropdown" style="float:right;">
    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Add New Video
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
  
   <li><a href="/educos/videos">Upload Video</a></li>
  ...
  <center>
<h1 style="color:#001E84; font-family:times new roman; font-weight:bold;"> Educos Learn's Online Session</h1>
  </center>
  <center>
    <c:forEach items="${vlist}" var="vid">
    <h2 style="color:black; font-family: sans-serif; font-weight:bold;">${vid.videosubject}</h2>
<iframe width="500" height="300" src="${vid.videolink}">
</iframe>
<h3 style="color:#16A085; font-family: sans-serif; font-weight:bold;">Uploaded By   - </h3><h3 style="color:#922B21;font-weight:bold; font-family: sans-serif;">${vid.uploadersname}</h3>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</c:forEach>
  </center>
