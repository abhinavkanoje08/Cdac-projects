  ...
  <div class="nav-container">
    ...
    <nav>
      <div class="nav-mobile">
        <a id="nav-toggle" href="/educos/home"><span></span></a>
      </div>
...
<br>
<br>
<center><h1 style="color:#024F40; margin-top: 1cm">Student Record</h1></center>
<br>
<br>
<br>
<table>
  ...
  <td>${stu.semail}</td>
   <td><spring:url 
  value="/educos/updates/${stu.sid}" var="updateURL"/>
  <a class="btn-login" href="${updateURL}" role="button">Update</a>
  </td>
  
  <td><spring:url 
  value="/educos/deletes/${stu.sid}" var="deleteURL"/>
