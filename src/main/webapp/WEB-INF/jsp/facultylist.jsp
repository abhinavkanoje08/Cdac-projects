...
<br>
<br>
<center><h1 style="color:#024F40; margin-top: 1cm">Faculty Record</h1></center>
<br>
<br>
<br>
...
<table >
  ...
  <td>${fac.femail}</td>
  <td><spring:url 
  value="/educos/update/${fac.fid}" var="updateURL"/>
  <a class="btn-login" href="${updateURL}" role="button">Update</a>
  </td>
  
  <td><spring:url 
  value="/educos/delete/${fac.fid}" var="deleteURL"/>
  <a class="btn-login" href="${deleteURL}" role="button">Delete</a>
  </td>
  </tr>
  </c:forEach>
</table>
<spring:url value="/educos/add" var="addURL"/>
<a class="btn-login" href="${addURL}" role="button">Add New Faculty</a>
<br>
<br>
<br>
</div>
